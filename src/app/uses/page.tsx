      ...
      <div className="space-y-20">
        <ToolsSection title="Workstation">
          ...
          <Tool title="2k 27” Monitor">
            I use a ViewSonic one because it fitted my needs at the time. It has
            USB-C charging which is cool. Will probably update to a better one.
          </Tool>
          <Tool title="Macbook Pro Keyboard and Trackpad">
            Yeah, I use the laptop keyboard and trackpad. It fits well my setup
            and I find it really comfy.
          </Tool>
        </ToolsSection>
        <ToolsSection title="Development tools">
          <Tool title="VS Code">
            I have a bunch of extensions and at this point is the editor that
            makes me the fastest. I want to try Fleet and I sometimes use other
            stuff like nvim in the terminal or JetBrains stuff for specific
            Python stuff.
          </Tool>
          <Tool title="iTerm2">
